...
describe("SurveyPage", () => {
  let wrapper;
  let markAssessmentDoneMock,
    saveAnswersMock,
    switchedSurveysMock,
    selectAssessmentsMock,
    onHideMock;

  beforeEach(() => {
    markAssessmentDoneMock = jest.fn();
    saveAnswersMock = jest.fn();
    switchedSurveysMock = jest.fn();
    selectAssessmentsMock = jest.fn();
    onHideMock = jest.fn();
